...
void loop() {
  ...
  String ten ="/C2I4/";
    ...
    for(int i=0;i<a10;i++){
      ...
      if(s10=="Forward"&&i==a10-1){
      runForward();
           Firebase.set("Path", 0);
      }else if(s10=="Forward"){
              runForward();
      }
      if(s10=="Right"&&i==a10-1){
      runRight();
           Firebase.set("Path", 0);
      }else if(s10=="Right"){
  ...
  String eleven ="/C2I5/";
    ...
    for(int i=0;i<a11;i++){
      ...
      if(s11=="Forward"&&i==a11-1){
      runForward();
           Firebase.set("Path", 0);
      }else if(s11=="Forward"){
              runForward();
      }
      if(s11=="Right"&&i==a11-1){
      runRight();
           Firebase.set("Path", 0);
      }else if(s11=="Right"){
   ...
   String twelve ="/C2I6/";
    ...
    for(int i=0;i<a12;i++){
      ...
      if(s12=="Forward"&&i==a12-1){
      runForward();
           Firebase.set("Path", 0);
      }else if(s12=="Forward"){
              runForward();
      }
      if(s12=="Right"&&i==a12-1){
      runRight();
           Firebase.set("Path", 0);
      }else if(s12=="Right"){
